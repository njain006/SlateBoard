...
public class Whiteboard extends Applet implements ActionListener, AdjustmentListener, MouseListener, MouseMotionListener
{
 ...
 /*
    Method is called up when an action event has been preformed.
